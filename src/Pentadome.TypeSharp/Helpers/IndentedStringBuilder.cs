...
// Copy and pasted from https://github.com/dotnet/efcore/blob/main/src/EFCore/Infrastructure/IndentedStringBuilder.cs
// Credits to microsoft.
// Slightly edited.
internal sealed class IndentedStringBuilder
{
    internal const byte IndentSize = 4;
    private int _indent;
    ...
    public IndentedStringBuilder(int initialIndent) => _indent = initialIndent;
    ...
    /// <inheritdoc cref="StringBuilder.Append(Int32)"/>
